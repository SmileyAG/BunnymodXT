...
typedef struct physent_unused_s
{
...
typedef struct playermove_unused_s
{
	...
	int				numphysent;    
	physent_unused_t		physents[MAX_PHYSENTS];
	// Number of momvement entities (ladders)
	int				nummoveent;
	// just a list of ladders
	physent_unused_t		moveents[MAX_MOVEENTS];	

	// All things being rendered, for tracing against things you don't actually collide with
	int				numvisent;
	physent_unused_t		visents[ MAX_PHYSENTS ];
	...
	void			*(*PM_HullForBsp)( physent_unused_t *pe, float *offset );
	float			(*PM_TraceModel)( physent_unused_t *pEnt, float *start, float *end, trace_t *trace );
	...
	pmtrace_t		(*PM_PlayerTraceEx) (float *start, float *end, int traceFlags, int (*pfnIgnore)( physent_unused_t *pe ) );
	int				(*PM_TestPlayerPositionEx) (float *pos, pmtrace_t *ptrace, int (*pfnIgnore)( physent_unused_t *pe ) );
	struct pmtrace_s *(*PM_TraceLineEx)( float *start, float *end, int flags, int usehulll, int (*pfnIgnore)( physent_unused_t *pe ) );
} playermove_unused_t;
